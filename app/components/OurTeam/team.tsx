  ...
  return (
    <div className="h-[895px] bg-smokey">
      ...
      <div className="grid grid-cols-3 gap-8 px-16">
        ...
        <div className="box w-[394.67px] h-[209px] p-4 flex flex-col items-center justify-between">
          <div className="flex justify-center items-center">
            <Image src="/joseph.svg" alt="Jane Doe" width={80} height={80} />
          </div>
        ...
        <div className="box w-[394.67px] h-[209px] p-4 flex flex-col items-center justify-between">
          <div className="flex justify-center items-center">
            <Image src="/bubblegirl.svg" alt="Alex Smith" width={80} height={80} />
          </div>
      ...
      <div className="grid grid-cols-3 gap-8 px-16 mt-28">
        ...
        <div className="box w-[394.67px] h-[209px] p-4 flex flex-col items-center justify-between">
          <div className="flex justify-center items-center">
            <Image src="/greenboy.svg" alt="James Nduku" width={80} height={80} />
          </div>
        ...
        <div className="box w-[394.67px] h-[209px] p-4 flex flex-col items-center justify-between">
          <div className="flex justify-center items-center">
            <Image src="/stephen.svg" alt="Jane Doe" width={80} height={80} />
          </div>
        ...
        <div className="box w-[394.67px] h-[209px] p-4 flex flex-col items-center justify-between">
          <div className="flex justify-center items-center">
            <Image src="/john.svg" alt="Alex Smith" width={80} height={80} />
          </div>
